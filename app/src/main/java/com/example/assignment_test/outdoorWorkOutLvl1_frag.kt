...
class outdoorWorkOutLvl1_frag : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_outdoor_work_out_lvl1_frag, container, false)
...
//                    gifImageView.setImageResource(R.drawable.) // Set image to check mark icon
    ...
    companion object {
        val exercises = arrayOf(
            Exercise("Slow Walk", R.drawable.gif_slow_walk, 300),
            Exercise("Crossover Step-Up", R.drawable.gif_crossover__step_up, 180),
            Exercise("Kick Crunch", R.drawable.gif_kick_crunch, 300),
            Exercise("Jogging", R.drawable.gif_jogging, 1200),
            Exercise("Slow Walk", R.drawable.gif_slow_walk, 300)
        )
    }
    ...
    private fun saveRecord(){
        ...
        reference.child(uid).child("powerPlantScore").addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                val divisionResult = (2280 / 60).toInt()
