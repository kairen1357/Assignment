...
class indoorWorkOutLvl1_frag : Fragment() {
...
//                    gifImageView.setImageResource(R.drawable.) // Set image to check mark icon
    ...
    companion object {
        val exercises = arrayOf(
            Exercise("Sit Up", R.drawable.gif_sit_up, 10),
            Exercise("Jumping Jacks", R.drawable.gif_jumping_jacks, 40),
            Exercise("Squat", R.drawable.gif_squat, 40),
            Exercise("Reverse Crunches", R.drawable.gif_reverse_crunches, 40),
            Exercise("Plank", R.drawable.gif_plank, 60),
            Exercise("Run in Place", R.drawable.gif_run_in_place, 60),
    ...
    private fun saveRecord(){
        ...
        reference.child(uid).child("powerPlantScore").addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                val divisionResult = (280 / 60).toInt()
