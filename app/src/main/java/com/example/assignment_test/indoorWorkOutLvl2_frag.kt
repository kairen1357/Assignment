...
class indoorWorkOutLvl2_frag : Fragment() {
...
//                    gifImageView.setImageResource(R.drawable.) // Set image to check mark icon
    ...
    companion object {
        val exercises = arrayOf(
            Exercise("Burpees", R.drawable.gif_burpees, 60),
            Exercise("Jumping Jacks", R.drawable.gif_jumping_jacks, 40),
            Exercise("Russian Twist", R.drawable.gif_russian_twist, 60),
            Exercise("Standing Criss-Cross", R.drawable.gif_standing_criss_cross, 40),
            Exercise("Knee Tucks", R.drawable.gif_knee_tucks, 40),
            Exercise("Run in Place", R.drawable.gif_run_in_place, 120),
            Exercise("Squad Jumps", R.drawable.gif_squad_jump, 60),
            Exercise("Inch Worms", R.drawable.gif_inch_worm, 45)
        )
    }
    ...
    private fun saveRecord(){
        ...
        reference.child(uid).child("powerPlantScore").addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                val divisionResult = (465 / 60).toInt()
        ...
        parentNode.updateChildren(childUpdates)
            .addOnSuccessListener {
                ...
                Log.d("DATABASE", "New node created successfully")
            }
            .addOnFailureListener { exception ->
                // Failed to create new node
                Log.e("DATABASE", "Failed to create new node. Error: ${exception.message}")
            }
    }
}
